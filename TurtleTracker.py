...
#
# Created by: Peter Satin (pms43@duke.edu)
# Created on: Oct 2016
...
obsDate = obsDateTime.split()[0]    # Observation date - first item in obsDateTime list object  ## When no paramater supplied, defaults to space
